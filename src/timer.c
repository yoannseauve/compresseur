...
unsigned int triacStartTime = 20000; //0XFFFF =>
...
void timerInit()
{
	...
	TIM3->DIER = TIM_DIER_CC1IE | TIM_DIER_CC3IE | TIM_DIER_CC4IE; //CC1, CC3, CC4 interrupt enabled
	...
	TIM3->CCER = TIM_CCER_CC1E; //input captur enabled on cc1, sensitiv on rising edge
